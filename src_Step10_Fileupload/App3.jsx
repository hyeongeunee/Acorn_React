    ...
    return (
        <div>
                ...
                onClick={() => {
                    ...
                    axios
                        ...
                        .then((res) => {
                            ...
                            const url =
                                'http://localhost:9000/boot07/api/file' +
                                '?saveFileName=' +
                                saveFileName +
                                '&orgFileName=' +
                                orgFileName +
            ...
            {state.fileSize != 0 && (
                <div>
                    <p>
                        원본 파일명 : <strong>{state.orgFileName}</strong>
                    </p>
                    <p>
                        저장 파일명 : <strong>{state.saveFileName}</strong>
                    </p>
                    <p>
                        파일의 크기 : <strong>{state.fileSize}</strong> byte
                    </p>
